...
# ``src.camera_client``. ``camera_ffmpeg`` imports back from this module lazily,
# so this top-level import forms no cycle.
from src.camera_ffmpeg import (  # noqa: F401 — re-exported public surface
    CAPTURE_DIR,
    LAST_SNAPSHOT_DIR,
    is_recording,
    mjpeg_frames,
