        ...
        VoiceCommand(
            ...
            phrasings=(
                ...
                Phrasing(
                    ...
                    example="Hey Jarvis, ¿dónde está papá?",
                ),
            ),
        ),
    ),
...
_GROCERY = VoiceCommandGroup(
    ...
    title="Grocery list",
    icon="sprout",
    summary="The shopping list, in Spanish only — it lives on the Spanish pipeline, so it always starts with “Hey Jarvis”.",
    commands=(
        VoiceCommand(
            id="grocery-add",
            intent="Add items",
            ...
            phrasings=(
                Phrasing(
                    ...
                    example="Hey Jarvis, añade leche y dos huevos a la lista",
                ),
            ),
        ),
        VoiceCommand(
            ...
            phrasings=(
                Phrasing(
                    ...
                    example="Hey Jarvis, quiero añadir cosas a la lista → “¿Qué quieres añadir?” → “leche y dos huevos”",
                ),
            ),
        ),
        VoiceCommand(
            ...
            phrasings=(
                Phrasing(
                    ...
                    example="Hey Jarvis, pon el objetivo de leche a cuatro",
                ),
            ),
        ),
        VoiceCommand(
            ...
            phrasings=(
                Phrasing(
                    ...
                    example="Hey Jarvis, anota que tenemos dos aceites",
                ),
            ),
        ),
        VoiceCommand(
            ...
            phrasings=(
                Phrasing(
                    ...
                    example="Hey Jarvis, no quedan huevos",
                ),
            ),
        ),
        VoiceCommand(
            ...
            phrasings=(
                Phrasing(
                    ...
                    example="Hey Jarvis, qué hay que comprar",
                ),
            ),
        ),
        VoiceCommand(
            ...
            phrasings=(
                Phrasing(
                    ...
                    example="Hey Jarvis, ¿qué puedo hacer?",
                ),
            ),
        ),
    ),
