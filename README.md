...
Alexa-style **wake alarms** and countdown **timers**, managed from a collapsible card on the Home tab (after the ["What can I say?" cheat sheet](#home-card-what-can-i-say-cheat-sheet-437), before the Activity log). This is deliberately **separate from the RISCO "Alarm controls"** card — a wake alarm rings/notifies at a set time, it never arms or disarms the security system (issue #304, Step 1/2; the voice-control wiring is Step 2/2, #306).
