...
| `ICLOUD_LABEL` / `ICLOUD_LABEL_2` | Optional friendly names (e.g. `Roberto` / `Ana`) used only in the self-heal Telegram messages above; unset falls back to "account 1"/"account 2". |
