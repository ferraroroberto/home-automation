...
def test_all_dialog_close_buttons_use_compact_44px_targets(
    ...
    # + the horizon-point editor dialog (#pvHorizonDialog, #578 part b); the
    # HA capabilities help left the census when #461 made it a folded
    # subsection instead of a modal.
    expect(close_buttons).to_have_count(22)
    expect(page.locator(".detail-close.hit-target")).to_have_count(22)
