...
def test_all_dialog_close_buttons_use_compact_44px_targets(
    ...
    # dialog (#513) + the reminder editor dialog (#314); the HA capabilities
    # help left the census when #461 made it a folded subsection instead of a
    # modal.
    expect(close_buttons).to_have_count(19)
    expect(page.locator(".detail-close.hit-target")).to_have_count(19)
